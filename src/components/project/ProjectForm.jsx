...
function ProjectForm({ handleSubmit, btnText, projectData }) { 
   ...
   return (
      <form onSubmit={submit} className={styles.form}>
         ...
         <Input type="numbar" text="Orçamento do projeto" name="budget" placeholder="Insira o orçamento total" handleOnChange={handleChange} value={project.budget ? project.budget : ''}/>
